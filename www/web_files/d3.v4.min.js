...
(function (t, n) {
    ...
    function s(t, n) {
        function e(e) {
            var o = null == s ? n.ticks ? n.ticks.apply(n, i) : n.domain() : s,
                u = null == f ? n.tickFormat ? n.tickFormat.apply(n, i) : mf : f,
                g = Math.max(l, 0) + p,
                y = n.range(),
                m = y[0] + .5,
                x = y[y.length - 1] + .5,
                b = (n.bandwidth ? a : mf)(n.copy()),
                w = e.selection ? e.selection() : e,
                M = w.selectAll(".domain").data([null]),
                T = w.selectAll(".tick").data(o, n).order(),
                k = T.exit(),
                S = T.enter().append("g").attr("class", "tick"),
                N = T.select("line"),
                E = T.select("text");
    ...
    function qt(t) {
        ...
        var e = Yt(t.r),
            r = Yt(t.g),
            i = Yt(t.b),
            o = Ot((.4124564 * e + .3575761 * r + .1804375 * i) / Hl),
    ...
    function Xt(t) {
        ...
        var n = t.r / 255,
            e = t.g / 255,
            r = t.b / 255,
            i = (ih * r + eh * n - rh * e) / (ih + eh - rh),
            o = r - i,
            u = (nh * (e - i) - Kl * o) / th,
            a = Math.sqrt(u * u + o * o) / (nh * i * (1 - i)),
    ...
    function Vn(t, n) {
        var e, r, i;
        return function () {
            var o = al(this).getComputedStyle(this, null),
    ...
    function Zn(t, n, e) {
        var r, i, o;
        return function () {
            var u = al(this).getComputedStyle(this, null),
    ...
    function ze(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                _ < h && (N *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, k in pd && Y.attr("cursor", hd[k = pd[k]])), y < d && (E *= -1, t = p, p = g, g = t, t = d, d = y, y = t, k in dd && Y.attr("cursor", hd[k = dd[k]])), A.selection && (z = A.selection), w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], y = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === y || (A.selection = [
                    [h, d],
                    [_, y]
                ], r.call(T), F.brush())
            }
            ...
            if (f.apply(this, arguments)) {
                var l, h, p, d, v, _, g, y, m, x, b, w, M, T = this,
                ...
                "overlay" === k ? A.selection = z = [
                    [l = n === fd ? P : D[0], p = n === sd ? L : D[1]],
                    [v = n === fd ? R : l, g = n === sd ? q : p]
                ] : (l = z[0][0], p = z[0][1], v = z[1][0], g = z[1][1]), h = l, d = p, _ = v, y = g;
                var I = bl(T).attr("pointer-events", "none"),
                    Y = I.selectAll(".overlay").attr("cursor", hd[k]);
        ...
        return e.move = function (t, e) {
            ...
            return arguments.length ? (s = "function" == typeof t ? t : ed([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), e) : s
        }, e.filter = function (t) {
    ...
    function si(t, n, e, r) {
        ...
        return function (u) {
            ...
            function d(o, u) {
                var a = i(o, u);
                if (_ && g.push([o, u]), T) y = o, m = u, x = a, T = !1, a && (S.lineStart(), S.point(o, u));
    ...
    function $i(t, n, e, r) {
        var i;
        if (null == t) i = e * __, r.point(-v_, i), r.point(0, i), r.point(v_, i), r.point(v_, 0), r.point(v_, -i), r.point(0, -i), r.point(-v_, -i), r.point(-v_, 0), r.point(-v_, i);
        else if (b_(t[0] - n[0]) > d_) {
            var o = t[0] < n[0] ? v_ : -v_;
        ...
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h,
                    ...
                    M = z_(x * x + b * b + w * w),
                    T = gr(w /= M),
                    k = b_(b_(w) - 1) < d_ || b_(o - l) < d_ ? (o + l) / 2 : M_(b, x),
                    S = t(k, T),
                    N = S[0],
                    E = S[1],
                    A = N - r,
    ...
    function no(t) {
        ...
        return n.stream = function (t) {
            ...
            return arguments.length ? (N = null == t ? (S = l = h = p = null, kg) : si(S = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == S ? null : [
                [S, l],
                [h, p]
            ]
        }, n.scale = function (t) {
    ...
    function lo(t, n) {
        ...
        var r = T_(t),
            i = t === n ? A_(t) : N_(r / T_(n)) / N_(fo(n) / fo(t)),
            o = r * E_(fo(t), i) / i;
    ...
    function Xo(t) {
        ...
        t: for (a = 3; a < i; ++a) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, v += d = r._.r * r._.r, _ += d * r._.x, g += d * r._.y, h = jo(n, o = _ / v, u = g / v);
            (r = r.next) !== e;)(d = jo(r, o, u)) < h && (n = r, h = d);
            e = n.next
        }
        for (n = [e._], r = e;
    ...
    function pu(t) {
        if (!t._start) try {
            ...
            if (t._tasks[t._ended + t._active - 1]) _u(t, n);
    ...
    function hs(t, n, e, r) {
        var i, o, u, a, c, s, f, l, h, p, d, v, _ = kw.length,
            g = !0;
    ...
    function xs(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = Tw._; a;) if ((r = bs(a, u) - o) > Cw) a = a.L;
        else {
            if (!((i = o - ws(a, u)) > Cw)) {
    ...
    function ks(t, n) {
        ...
        for (Nw = [], kw = new Array(t.length), Tw = new Gc, Sw = new Gc;;) if (i = Mw, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (xs(o), e = o[0], r = o[1]), o = t.pop();
        else {
            if (!i) break;
            ms(i.arc)
        }
    ...
    var Ls = function (t, n) {
        ...
        Bs = function (t, n) {
            var e, r, i = t.length,
                ...
                a = -1,
                c = 0;
            if (null == n) for (; ++a < i;) isNaN(e = Ys(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
            else for (; ++a < i;) isNaN(e = Ys(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
            if (c > 1) return u / (c - 1)
        },
        js = function (t, n) {
            var e = Bs(t, n);
        ...
        cf = function (t, n) {
            var e, r = 0,
                ...
                o = -1,
                u = i;
            if (null == n) for (; ++o < i;) isNaN(e = Ys(t[o])) ? --u : r += e;
            else for (; ++o < i;) isNaN(e = Ys(n(t[o], o, t))) ? --u : r += e;
            if (u) return r / u
        },
        sf = function (t, n) {
            var e, r = [],
                i = t.length,
                o = -1;
            if (null == n) for (; ++o < i;) isNaN(e = Ys(t[o])) || r.push(e);
            else for (; ++o < i;) isNaN(e = Ys(n(t[o], o, t))) || r.push(e);
    ...
    var Sf = "http://www.w3.org/1999/xhtml",
        Nf = {
    ...
    if (t.event = null, "undefined" != typeof document) {
        "onmouseenter" in document.documentElement || (qf = {
    ...
    var fl = function (t, n) {
        ...
        _l = function (t, n) {
            var e = "function" == typeof t ? t : Af(t),
                r = null == n ? st : "function" == typeof n ? n : If(n);
            return this.select(function () {
    ...
    var El = function () {
        ...
        Ll = /^#([0-9a-f]{3})$/,
        Rl = /^#([0-9a-f]{6})$/,
        ql = new RegExp("^rgb\\(" + [Cl, Cl, Cl] + "\\)$"),
        Ul = new RegExp("^rgb\\(" + [Pl, Pl, Pl] + "\\)$"),
        Dl = new RegExp("^rgba\\(" + [Cl, Cl, Cl, zl] + "\\)$"),
        Ol = new RegExp("^rgba\\(" + [Pl, Pl, Pl, zl] + "\\)$"),
        Fl = new RegExp("^hsl\\(" + [zl, Pl, Pl] + "\\)$"),
        Il = new RegExp("^hsla\\(" + [zl, Pl, Pl, zl] + "\\)$"),
        Yl = {
            aliceblue: 15792383,
    ...
    Al($t, Vt, wt(Mt, {
        ...
        rgb: function () {
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Bl,
                n = +this.l,
    ...
    var oh, uh, ah, ch, sh, fh, lh = function (t) {
        ...
        bh = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
        wh = new RegExp(bh.source, "g"),
        Mh = function (t, n) {
            var e, r, i, o = bh.lastIndex = wh.lastIndex = 0,
                u = -1,
                a = [],
                c = [];
            for (t += "", n += "";
            (e = bh.exec(t)) && (r = wh.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
                i: u,
                x: mh(e, r)
            })), o = wh.lastIndex;
    ...
    var td = [null],
        nd = function (t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i) if ((e = i[r]).state > tp && e.name === n) return new Kn([
                    [t]
                ], td, n, +r)
            }
            return null
        ...
        arcTo: function (t, n, e, r, i) {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);
                ...
                var h = e - o,
                    ...
                    _ = Math.sqrt(d),
                    g = Math.sqrt(l),
                    y = i * Math.tan((Nd - Math.acos((d + l - v) / (2 * _ * g))) / 2),
                    m = y / g,
                    x = y / _;
    ...
    var fv, lv = function (t) {
        ...
        Tv = function (t, n) {
            ...
            var r = e[0],
                i = e[1],
                o = i - (fv = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
                u = r.length;
    ...
    var Ev, Av = function (t) {
        ...
        Cv = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
        zv = function (t) {
            function n(t) {
                function n(t) {
                    var n, i, s, m = v,
            ...
            function e(t, e) {
                var r = n((t = lr(t), t.type = "f", t)),
                    i = 3 * Math.max(-8, Math.min(8, Math.floor(xv(e) / 3))),
                    o = Math.pow(10, -i),
                    u = Cv[8 + i / 3];
                return function (t) {
                    return r(o * t) + u
            ...
            var r = t.grouping && t.thousands ? bv(t.grouping, t.thousands) : Av,
                i = t.currency,
                o = t.decimal,
    ...
    var Uv, Dv, Ov, Fv, Iv, Yv, Bv, jv, Hv, Xv, Vv, $v, Wv, Zv, Gv, Jv, Qv, Kv, t_, n_, e_, r_, i_, o_, u_, a_, c_, s_, f_, l_, h_, p_ = new dr,
        d_ = 1e-6,
        v_ = Math.PI,
        __ = v_ / 2,
        g_ = v_ / 4,
    ...
    function (t) {
        ...
        return Zv = Gv = null, Yv === 1 / 0 || Bv === 1 / 0 ? [
            [NaN, NaN],
            [NaN, NaN]
        ] : [
            [Yv, Bv],
        ...
        og = function () {
            ...
            function n() {
                var t = i.apply(this, arguments),
                    n = o.apply(this, arguments) * x_,
                    c = u.apply(this, arguments) * x_;
            ...
            function i(t) {
                ...
                return {
                    ...
                    point: function (l, h) {
                        var p, d = [l, h],
                            v = r(l, h),
                            _ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? v_ : -v_), h) : 0;
                        if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (cg(n, p) || cg(d, p)) && (d[0] += d_, d[1] += d_, v = r(d[0], d[1]))), v !== i) f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p;
                        else if (s && n && c ^ v) {
                            var g;
    ...
    var ey = 16,
        ...
        cy = function () {
            ...
            var e, r, i, o, u, a, c = ay(),
                s = uy().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
                f = uy().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
                l = {
                    point: function (t, n) {
                        a = [t, n]
                    }
            ...
            return t.invert = function (t) {
                ...
                return i = c.translate(t).clipExtent([
                    ...
                    [r - .425 * e + d_, a + .12 * e + d_],
                    [r - .214 * e - d_, a + .234 * e - d_]
                ]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([
                    [r - .214 * e + d_, a + .166 * e + d_],
                    [r - .115 * e - d_, a + .234 * e - d_]
                ]).stream(l), n()
        ...
        yy = function () {
            ...
            return u = {
                ...
                clipExtent: function (i) {
                    return arguments.length ? (d = null == i ? (p = n = e = r = null, kg) : si(p = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]), t()) : null == p ? null : [
                        [p, n],
                        [e, r]
                    ]
                },
    ...
    var cm = function (t, n) {
        ...
        bm = xm("text/csv", Od),
        wm = xm("text/tab-separated-values", jd),
        Mm = Array.prototype,
        Tm = Mm.map,
        km = Mm.slice,
        Sm = {
    ...
    var Fx = Date.prototype.toISOString ? Ga : t.utcFormat("%Y-%m-%dT%H:%M:%S.%LZ"),
        Ix = +new Date("2000-01-01T00:00:00.000Z") ? Ja : t.utcParse("%Y-%m-%dT%H:%M:%S.%LZ"),
        Yx = 1e3,
        Bx = 60 * Yx,
        jx = 60 * Bx,
        Hx = 24 * jx,
        ...
        nb = Oh(Vt(300, .5, 0), Vt(-240, .5, 1)),
        eb = Oh(Vt(-100, .75, .35), Vt(80, 1.5, .8)),
        rb = Oh(Vt(260, .75, .35), Vt(80, 1.5, .8)),
        ib = Vt(),
        ob = function (t) {
        ...
        wb = function () {
            function t() {
                var t, s, f = +n.apply(this, arguments),
                    ...
                    d = lb(p - h),
                    v = p > h;
                if (c || (c = t = Re()), l < f && (s = l, l = f, f = s), l > yb) if (d > bb - yb) c.moveTo(l * pb(h), l * _b(h)), c.arc(0, 0, l, h, p, !v), f > yb && (c.moveTo(f * pb(p), f * _b(p)), c.arc(0, 0, f, p, h, v));
                else {
                    var _, g, y = h,
                        m = p,
                        x = h,
                        ...
                        S = vb(lb(l - f) / 2, +r.apply(this, arguments)),
                        N = S,
                        E = S;
                    if (k > yb) {
                        var A = ic(k / f * _b(T)),
                    ...
                    if (S > yb) {
                        var q = l * pb(m),
                            ...
                            O = f * _b(x);
                        if (d < mb) {
                            var F = w > yb ? fc(z, P, D, O, q, U, L, R) : [L, R],
                                I = z - F[0],
                                Y = P - F[1],
                                B = q - F[0],
                                j = U - F[1],
                                H = 1 / _b(rc((I * B + Y * j) / (gb(I * I + Y * Y) * gb(B * B + j * j))) / 2),
    ...
    var Cb = function () {
        ...
        Db = Math.sin(mb / 10) / Math.sin(7 * mb / 10),
        Ob = Math.sin(bb / 10) * Db,
        Fb = -Math.cos(bb / 10) * Db,
        Ib = {
            draw: function (t, n) {
    ...
    Uc.prototype = {
        ...
        lineEnd: function () {
            ...
            else for (var r = Bc(t), i = Bc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
        ...
        Uw = function () {
            ...
            function f() {
                ...
                if (!g && y.apply(this, arguments)) {
                    var o = a(this, arguments),
                        u = bl(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0),
                        c = Ff(this);
            ...
            return n.transform = function (t, n) {
                ...
                return arguments.length ? (m = "function" == typeof t ? t : Lw([
                    [+t[0][0], +t[0][1]],
                    [+t[1][0], +t[1][1]]
                ]), n) : m
