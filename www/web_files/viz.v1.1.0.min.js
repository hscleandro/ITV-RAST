...
function () {
    ...
    function n(t, n, e, r, a, i) {
        if (0 >= a || 0 >= r) return 0;
        var u = t.concat().sort(d3.ascending),
            o = r - u.length * n + (i ? n : 0),
            s = [],
            c = 0,
            d = 0;
    ...
    u.bP = function () {
        function t(i) {
            y = i, i.each(function () {
                var i = d3.select(this),
                    u = t.bars(),
                    o = i.selectAll(".subBars").data(u.subBars).enter().append("g").attr("transform", function (t) {
        ...
        return t.data = function (n) {
            ...
            function a(n) {
                ...
                var a = d3.nest().key("primary" == n ? t.keyPrimary() : t.keySecondary()).sortKeys("primary" == n ? t.sortPrimary() : t.sortSecondary()).rollup(function (t) {
                    ...
                    i = o(a, t.pad(), t.min(), 0, "vertical" == f ? t.height() : t.width()),
                    u = t.barSize();
            ...
            function i(n) {
                ...
                i.forEach(function (e) {
                    var r = a.get(e.key),
                        i = o(e.values, 0, 0, "vertical" == f ? r.y - r.height : r.x - r.width, "vertical" == f ? r.y + r.height : r.x + r.width),
                        u = t.barSize();
            ...
            function o(t, n, e, r, a) {
                var i = e / (a - r - 2 * t.length * n),
                    u = 0,
                    o = 0,
                    s = d3.sum(t, function (t) {
                        return t.value
                    });
                t.forEach(function (t) {
                    t.value < i * s && (u += 1, o += t.value)
                });
                var c = 1e-5 > s ? 0 : (a - r - 2 * t.length * n - u * e) / (s - o),
                    d = r,
                    f = [];
        ...
        function t(n) {
            g = n, n.each(function () {
                ...
                var g = t.outerRadius() / b.outerRadius,
                    h = 180 * t.scale()(t.value()) / s + 90;
        ...
        return t.scale = function () {
            ...
            var r = 180 * t.scale()(n) / s + 90,
                a = 180 * t.scale()(t.value()) / s + 90,
                i = t.ease();
        ...
        function u(t) {
            ...
            p = t, k || f(), t.each(function () {
                var t = d3.select(this),
                    r = t.selectAll(".groups").data(x).enter().append("g").attr("class", "groups").on("mouseover", u.mouseover).on("mouseout", u.mouseout),
                    a = r.append("text").attr("class", "label"),
                    i = (1 + u.labelPadding()) * u.outerRadius(),
                    s = u.valueFormat();
                a.filter(function (t) {
                    return "g" == t.type
                }).attr("x", function (t) {
        ...
        function s(t) {
            ...
            var g = p.selectAll(".groups").data(t ? b : u.groups()),
                h = (1 + u.labelPadding()) * u.outerRadius(),
                y = u.valueFormat();
        ...
        function g(t, e, r, a, i) {
            ...
            var d = t.filter(function (t) {
                ...
                f = 2 * Math.PI - (u ? t[o].endAngle - t[o].startAngle + 2 * e : 0),
                l = u ? t[o].endAngle + e : i,
                g = d3.sum(d),
                p = n(d, e, r, 0 >= f ? 0 : f, g, u ? !0 : !1);
